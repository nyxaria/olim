...
class Coil:
    ...
    def calculate_magnetic_field(self, tube, coil_layers=None, z=0.0):
        ...
        if self.current:
            ...
            I = self.max_current * 0.9  # set a safety margin
    ...
    def calculate_force_between_plunger_and_coil(self, tube, Bsol_z=None, Bmag=1.241, coil_layers=None, z=0.0):
        if not Bsol_z:
        ...
        d = tube.OD + _coil_layers * self.wire_d / 2
